...
##   - same-domain: Only send the Referer for the same domain.
...
## from hostblocking.
## Type: List of UrlPattern
# c.content.blocking.hosts.whitelist = []
...
## Allow JavaScript to close windows
## Type: Bool
# c.content.javascript.can_close_windows = True
...
## Type: Padding
c.tabs.indicator.padding = {'top': 2, 'bottom': 2, 'left': 4, 'right': 4}
...
## Type: Int
# c.tabs.show_switching_delay = 4200
...
config.bind(';P', 'print --pdf ./pdf/{title}.pdf')
# config.bind('<Ctrl-B>', 'scroll-page 0 -1')
config.bind('d', 'scroll-page 0 0.85')
...
config.bind('u', 'scroll-page 0 -0.85')
...
config.bind('h', 'scroll-px -350 0')
config.bind('j', 'scroll-px 0 350')
config.bind('k', 'scroll-px 0 -350')
config.bind('l', 'scroll-px 350 0')
...
config.bind('X', 'greasemonkey-reload')
...
config.bind('<Ctrl-k>', 'completion-item-focus prev-category', mode='command')
# config.bind('<Ctrl-Tab>', 'completion-item-focus next-category', mode='command')
config.bind('<Ctrl-j>', 'completion-item-focus next-category', mode='command')
